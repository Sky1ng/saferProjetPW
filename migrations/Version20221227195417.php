 ...
 */
final class Version20221227195417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien ADD titre VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD code_postal VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien DROP titre, DROP description, DROP code_postal');
    }
}
